...
const table2excel = (column, data, excelName) => {
    ...
    function getImageHtml(val, options) {
        ...
        return `<td style="width: ${options.width}px; height: ${options.height}px; text-align: center; vertical-align: middle;padding: 5px;"><img src="${val}" width=${options.width} height=${options.height}></td>`
    }
}
