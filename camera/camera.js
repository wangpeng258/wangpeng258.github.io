(function (global, factory) {
    ...
    (global = global || self, global.Camera = factory());
})(this,function(){
    class Camera {
        ...
        open(deviceId) {
            return new Promise(async (resolve, reject) => {
                if (!this.isVideo(this.video)) {
                    ...
                    let errMsg = "video not HTMLElement";
                    reject({errMsg});
                }else{
        ...
        stop() {
            return new Promise((resolve) => {
                this.isOpen && this.stream && this.stream.getVideoTracks().forEach(async track => {
                    await track.stop();
                })
                resolve(this);
            })
